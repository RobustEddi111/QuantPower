...
## 甘肃
# ========= 文件路径需要改这里 =========
DATA_DIR = r"D:\工作\特变电工\13项目\储能充放电节点收益分析\储能节点收益分析\甘肃2025年节点电价数据\甘肃2025年节电电价数据标准化Schema"
OUT_DIR  = r"D:\工作\特变电工\13项目\储能充放电节点收益分析\储能节点收益分析\甘肃2025年节电电价数据储能收益测算-按月分时-考虑四项费用"
# =================================
...
SOC_MIN = 0.10 * E_MWH
SOC_MAX = 0.90 * E_MWH
SOC0_FRAC = 0.1      # 每天初始SOC占比（并要求日末回到初值）
